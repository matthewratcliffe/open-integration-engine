 ...
 * {@link org.openintegrationengine.connectors.generator.server.GeneratorSerializerPlugin}.
 *
 ...
 */
public class GeneratorSerializerClientPlugin extends ClientPlugin {
    ...
    public GeneratorSerializerClientPlugin(String name) {
        super(name);
        register();
    }
